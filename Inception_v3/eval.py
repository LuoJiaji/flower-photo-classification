...
import skimage.data
# 模型目录
CHECKPOINT_DIR = './runs/1527733815/checkpoints'
...
# 测试数据
file_path = './data/flower_photos/tulips/54895006_55b49052dc.jpg'
y_test = []
y_test.append(4)
print(y_test)
...
# data = skimage.data.imread(file_path)
# image_data.append(data)
# image_data.append(data)
# image_data = tf.image.decode_jpeg(data)
# print(type(data))
print()
# print(type(data))
